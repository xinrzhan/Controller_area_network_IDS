...
with open('Format_RandomLog_Generator(Fuzzy).csv', 'w', newline='') as csv_file:
    writer = csv.writer(csv_file, delimiter=',')
    writer.writerow(["Length", "ID", "Data0", "Data1", "Data2", "Data3", "Data4", "Data5", "Data6", "Data7"])
    i = 0
    while i < times:

        Length = random.randrange(0, 9)
        Random_id = random.randrange(0, 2048)
